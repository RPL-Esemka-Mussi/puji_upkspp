                    ...
                    @foreach ($siswa as $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='{{ url("/pembayaran/transaksi/history") }}' class="btn btn-info btn-sm"><i
                                    class="bi bi-credit-card mx-1"></i>History</a>
                                    @else
                                    <a href='{{ url("pembayaran/transaksi/$data->id") }}' class="btn btn-info btn-sm"><i
                                        class="bi bi-credit-card mx-1"></i>Transaksi</a>
                                @endif
                                @can('admin')
                                    <a href='{{ url("pembayaran/cetak/$data->id") }}' class="btn btn-info btn-sm"><i
                                    class="bi bi-printer-fill mx-2 "></i>Print Id</a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
