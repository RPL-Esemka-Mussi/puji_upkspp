    ...
    <nav class="navbar navbar-expand-lg bg-primary navbar-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-dark" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <a class="nav-link {{ Request::segment(1) == 'home' ? 'active text-dark' : '' }}"
                    ...
                    @can('siswa')
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'history' ? 'active text-dark' : '' }}"
                                href="{{ url('/history') }}"><b>History</b></a>
                        </li>
                    @endcan
                </ul>
                            ...
                            <li class="nav-item">
                                <form action="/logout" method="post">
                                    ...
                                    <button type="submit" class="dropdown-item"><i
                                            class="bi bi-box-arrow-right"></i><b>Logout</b></button>
                                </form>
                            </li>
                        </ul>
                    @else
