...
class siswacontroller extends Controller
{
    ...
    public function simpan(Request $request)
    {
        ...
        try{
          ...
          Siswa::create([
            ...
            return redirect('siswa')->with('sukses' ,'data berhassil di tambah');
        }catch(\Exception $e){
    ...
    public function edit($id)
    {
        ...
        return view('siswa.edit', compact('siswa', 'kelas'));
            ...
            return redirect('siswa')->with('sukses' ,'data berhassil di edit');
        }catch(\Exception $e){
            return redirect('siswa')->with('gagal' ,'data gagal');
        }
    }
    ...
    public function update(Request $request)
    {
        try{
            ...
            return redirect('siswa')->with('sukses' ,'data berhassil di update');
        }catch(\Exception $e){
            return redirect('siswa')->with('gagal' ,'data gagal');
        }
    }
